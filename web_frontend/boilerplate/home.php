...
<body>
  ...
  <div id="maincontainer" class="billcontainer">
    ...
    <div id="main">
		<div class="controls">
			<a href="main.php">Make a bill</a>
		</div>
		<div class="madeBills title">Bills</div>
		<div id="bills" class="madeBills">
<?
			foreach ($bills as $bill)
			{
				?>
				<div class="bill"><a href="displayBill.php?bill=<?echo $bill['bill_id'];?>"><?echo $bill['billName'];?> [$<?echo $bill['billAmount'];?>] (<?echo $bill['dueDate'];?>)</a></div><br/>
				<?
			}
?>
		</div>
